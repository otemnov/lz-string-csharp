...
namespace lz_string_csharp
{
	public class LZString
	{
		...
		private static ContextCompressData writeBit(int value, byte bitsPerChar, ContextCompressData data,
			Func<int, char> getCharFromInt)
		{
		...
		private static ContextCompressData writeBits(int numbits, byte bitsPerChar, int value, ContextCompressData data,
			Func<int, char> getCharFromInt)
		{
